...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="selection:bg-amber-400 selection:text-zinc-900">
    ...
    <!-- Background utama diubah menjadi putih bersih (bg-white) -->
        ...
        <div class="flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10 relative z-10">
            <div class="flex w-full max-w-sm flex-col gap-4">
                ...
                <a href="{{ route('home') }}" class="flex flex-col items-center gap-3 font-medium group mb-2" wire:navigate>
                    ...
                    <span class="flex h-16 w-16 items-center justify-center rounded-2xl bg-zinc-950 border border-zinc-800 shadow-xl shadow-emerald-500/10 transition-transform group-hover:scale-105 duration-200">
                    ...
                    <span class="text-xs font-black tracking-widest text-zinc-400 uppercase">RME PORMIKI JABAR</span>
                </a>
