                ...
                <div class="p-5 bg-zinc-50 dark:bg-zinc-950/40 border border-zinc-200/60 dark:border-zinc-800/80 rounded-xl mb-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-zinc-200/60 dark:border-zinc-800/80 pb-4">
                        ...
                        <div>
                            ...
                            <select wire:model="presc_metode_racik_id" class="block w-full rounded-lg border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-3 py-2 text-sm text-zinc-900 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">
                                ...
                                <option value="{{ $m->id }}" wire:key="metode-opt-umum-{{ $m->id }}">{{ $m->nama_metode_racik }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                        <div class="md:col-span-6 relative">
                            ...
                            <div wire:key="drug-dropdown-umum" class="absolute z-50 left-0 right-0 mt-1 max-h-60 overflow-y-auto bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg shadow-lg">
                                @foreach ($drugResults as $res)
                                <button type="button" wire:click="selectDrug({{ $res['id'] }})" wire:key="drug-item-umum-{{ $res['id'] }}-{{ $loop->index }}" class="w-full text-left px-4 py-2.5 hover:bg-zinc-50 dark:hover:bg-zinc-800 border-b border-zinc-100 dark:border-zinc-800/80 text-xs flex justify-between items-center transition-colors">
                    ...
                    <div class="bg-zinc-100/50 dark:bg-zinc-950 p-4 rounded-lg border border-zinc-200/50 dark:border-zinc-800">
                        ...
                        <div class="space-y-2">
                            ...
                            <div wire:key="ing-row-umum-{{ $i }}" class="flex justify-between items-center text-xs p-2 bg-white dark:bg-zinc-900 rounded border border-zinc-150 dark:border-zinc-850">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select wire:model="presc_aturan_pakai" class="block w-full rounded-lg border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-3 py-2 text-sm text-zinc-900 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">
                                ...
                                <option value="{{ $ap->nama_aturan_pakai }}" wire:key="aturan-opt-umum-{{ $ap->id }}">{{ $ap->nama_aturan_pakai }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden bg-white dark:bg-zinc-900">
                    <flux:table>
                        ...
                        <flux:table.rows>
                            ...
                            <flux:table.row :key="'presc-row-umum-'.$index">
                                <flux:table.cell>
                                ...
                                <flux:table.cell class="text-xs">
                                    ...
                                    <ul class="list-disc pl-4 space-y-0.5">
                                        ...
                                        <li wire:key="presc-item-umum-{{ $index }}-{{ $itemIndex }}">{{ $item['nama_obat'] }} <span class="text-zinc-500 font-mono text-[10px]">({{ $item['jumlah'] }} {{ $item['satuan'] }})</span></li>
                                        @endforeach
                                    </ul>
                                    @else
            ...
            <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 shadow-sm">
                ...
                <div class="mb-5">
                    ...
                    <select wire:model.live="selectedLabTestId" class="block w-full rounded-lg border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-3 py-2 text-sm text-zinc-900 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">
                        ...
                        <option value="{{ $item->id }}" wire:key="lab-item-option-umum-{{ $item->id }}">
                ...
                <div class="border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden">
                    <flux:table>
                        ...
                        <flux:table.rows>
                            ...
                            <flux:table.row wire:key="lab-test-umum-{{ $idx }}">
                ...
                <div class="mt-4 flex justify-end">
                    <div class="bg-purple-50 dark:bg-purple-950/30 border border-purple-200/50 dark:border-purple-850/50 rounded-lg px-5 py-3 flex items-center gap-4">
                ...
                <div class="border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden">
                    <flux:table>
                        ...
                        <flux:table.rows>
                            ...
                            <flux:table.row wire:key="doc-row-umum-{{ $doc['type'] }}-{{ $doc['id'] }}">
...
<div class="flex justify-end bg-zinc-50 dark:bg-zinc-950 p-6 rounded-xl border border-zinc-200/60 dark:border-zinc-800/80">
        <div class="flex gap-2">
            @if ($isEditable)
            <flux:button variant="filled" wire:click="saveDraft">Simpan</flux:button>
